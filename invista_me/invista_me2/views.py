...
def politica_privacidade(request):
    return HttpResponse('Pagina com informações de politica de privacidade') # e aqui usamos somente o httpreponse para carrega a url somente, sem necessada de pagina rendererizada. 


def investimentos_funcao(request):
    dados = {
